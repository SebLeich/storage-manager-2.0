...
export class OrdersComponentService {
    ...
    private _setUp() {
        ...
        this._subscriptions.add(...[
            this._calculationContextStore.select(selectContainerHeight).pipe(distinctUntilChanged()).subscribe((height: number) => this.formGroup.controls['containerHeight'].setValue(height, { emitEvent: false })),
